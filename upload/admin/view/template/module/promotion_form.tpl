                    ...
                    <div id="language<?php echo $language['language_id']; ?>">
                        <table class="form">
                            <tr>
                                ...
                                <td>
                                    <input type="text"
                                           name="promotion_description[<?php echo $language['language_id']; ?>][name]"
                                           size="100"
                                           value="<?php echo isset($promotion_description[$language['language_id']]) ? $promotion_description[$language['language_id']]['name'] : ''; ?>"/>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="hidden"
                                           name="promotion_description[<?php echo $language['language_id']; ?>][image]"
                                           value="<?php echo $promotion_description[$language['language_id']]['image']; ?>"
                                           id="image<?php echo $language['language_id']?>"/>
                                    <img src="<?php echo $promotion_description[$language['language_id']]['image_url']; ?>"
                                         alt="" id="preview<?php echo $language['language_id']?>" class="image"
                                         onclick="image_upload('image<?php echo $language['language_id']?>', 'preview<?php echo $language['language_id']?>');"/>
                                    <br/>
                                    <a onclick="image_upload('image<?php echo $language['language_id']?>', 'preview<?php echo $language['language_id']?>');"><?php echo $text_browse; ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;
                                    <a onclick="$('#thumb<?php echo $language['language_id']?>').attr('src', '<?php echo $no_image; ?>'); $('#image<?php echo $language['language_id']?>').attr('value', '');"><?php echo $text_clear; ?></a>
                    </div>
                    </td>
                    </tr>
                    <tr>
